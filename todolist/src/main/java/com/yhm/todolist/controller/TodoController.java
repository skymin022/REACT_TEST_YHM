package com.yhm.todolist.controller;
...
import com.yhm.todolist.domain.Pagination;
import com.yhm.todolist.domain.Todos;
import com.yhm.todolist.service.TodoService;
...
public class TodoController {
    ...
    public ResponseEntity<?> getAll(
        ...
        try {
            log.debug("getAll called with page={}, size={}", page, size);
            ...
            log.debug("Returning {} todos with pagination {}", list.size(), pagination);
